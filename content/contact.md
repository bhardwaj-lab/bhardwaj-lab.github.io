...
<section class="lg:pb-24">
  <div class="max-w-screen-md px-4 mx-auto">
      <p class="mb-8 font-light text-center text-gray-500 lg:mb-16 dark:text-gray-400 sm:text-xl">Want to learn more about our research? Have a feedback or interested in joining/collaborating with us? Let us know.</p>
      <form name="contact" action="https://formsubmit.co/3a6fe8a418a1fbfb7903d5859ca739da" method="POST" class="space-y-8">
          <div class="my-4">
